(() => {
    ...
    function initSliders() {
        if (document.querySelector(".jobs-page__slider")) new core(".jobs-page__slider", {
        ...
        if (document.querySelector(".locations-page__slider")) new core(".locations-page__slider", {
    ...
    function playVideo1() {
        ...
        } else decorationPageVideo.pause();
    }
    ...
    spollersTitle.forEach(((element, index) => {
        element.addEventListener("click", (function(e) {
            ...
            } else descriptionPageMore[index].style.display = "block";
        }));
    }));
